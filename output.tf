...
output "ingress_public_ipv4" {
  ...
  value       = module.control_planes[keys(module.control_planes)[0]].ipv4_address
}
...
output "k3s_endpoint" {
  ...
  value       = "https://${module.control_planes[keys(module.control_planes)[0]].private_ipv4_address}:6443"
}
