module "control_planes" {
  ...
  ipv4_subnet_id               = var.use_private_network ? hcloud_network_subnet.control_plane[[for i, v in var.control_plane_nodepools : i if v.name == each.value.nodepool_name][0]].id : null
